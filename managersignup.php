<html>
  ...
  <head>
    <title> Manager Signup | only Cafe' </title>
  </head>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top navigation-clean-search" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">only Cafe'</a>
        </div>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Shreya, <br> Welcome to <span class="edit"> only Cafe' </span></h1>
     <br>
  ...
  <br>
  <p> shreya Exploria 2022| &copy All Rights Reserved </p>
  <br>
  </footer>
</html>